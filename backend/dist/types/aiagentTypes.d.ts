...
export type AgentTaskType = 'SCHEDULE_APPOINTMENT' | 'CREATE_PRESCRIPTION' | 'ORDER_LAB_TEST' | 'ANALYZE_SYMPTOMS' | 'GENERATE_REFERRAL' | 'SUMMARIZE_RECORDS' | 'CHECK_DRUG_INTERACTIONS' | 'TRIAGE_PATIENT' | 'GENERATE_REPORT' | 'SEND_NOTIFICATION';
...
//# sourceMappingURL=aiagentTypes.d.ts.map