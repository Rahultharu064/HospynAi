...
export type DocumentScanType = 'PRESCRIPTION' | 'LAB_REPORT' | 'INSURANCE_CARD' | 'ID_PROOF' | 'MEDICAL_CERTIFICATE' | 'DISCHARGE_SUMMARY' | 'GENERIC';
export type OcrStatus = 'PROCESSING' | 'COMPLETED' | 'REVIEW_NEEDED' | 'VERIFIED' | 'FAILED';
export type FieldExtractionType = 'PATIENT_INFO' | 'PRESCRIPTION_DATA' | 'LAB_RESULTS' | 'INSURANCE_INFO' | 'DOCTOR_INFO' | 'MEDICATION_INFO';
...
//# sourceMappingURL=ocrTypes.d.ts.map