...
exports.requirePatientConsent = requirePatientConsent;
exports.minimumNecessaryAccess = minimumNecessaryAccess;
exports.enforceEncryption = enforceEncryption;
exports.enforceDataRetention = enforceDataRetention;
exports.requireBAA = requireBAA;
exports.enforceGDPRCompliance = enforceGDPRCompliance;
exports.rightToErasure = rightToErasure;
exports.dataPortability = dataPortability;
exports.dataMinimization = dataMinimization;
exports.preventCardDataStorage = preventCardDataStorage;
exports.securePaymentTransmission = securePaymentTransmission;
exports.complianceAuditTrail = complianceAuditTrail;
exports.validateSessionForCompliance = validateSessionForCompliance;
exports.requireComplianceTraining = requireComplianceTraining;
exports.complianceRateLimit = complianceRateLimit;
exports.complianceHeaders = complianceHeaders;
 ...
 */
function auditPHIAccess(resource) {
    return async (req, res, next) => {
        ...
        res.json = function (body) {
            ...
            auditService_1.AuditService.log({
                ...
                logger_1.default.error('Failed to log PHI access:', error);
            });
 ...
 */
function requirePatientConsent(resourceType) {
    return async (req, res, next) => {
        try {
            ...
            if (!hasConsent) {
                ...
                throw new errors_1.ForbiddenError('Patient consent is required to access these records. Please obtain proper authorization.');
            }
            next();
        }
        catch (error) {
 ...
 */
function minimumNecessaryAccess(allowedFields) {
    return (req, res, next) => {
        const originalJson = res.json.bind(res);
        res.json = function (body) {
            ...
            if (body && body.data) {
                if (Array.isArray(body.data)) {
                    body.data = body.data.map((item) => filterFields(item, allowedFields));
                }
 ...
 */
function enforceEncryption(req, res, next) {
 ...
 */
function enforceDataRetention(retentionDays) {
    return (req, res, next) => {
 ...
 */
function requireBAA(organizationId) {
    return async (req, res, next) => {
        try {
            ...
            if (!subscription) {
                throw new errors_1.ForbiddenError('A valid Business Associate Agreement (BAA) is required. Please contact support.');
            }
            next();
        }
        catch (error) {
 ...
 */
function enforceGDPRCompliance() {
    return (req, res, next) => {
    ...
    return (req, res, next) => {
        if (req.body) {
            ...
            if (unauthorizedFields.length > 0) {
                ...
                logger_1.default.warn(`Data minimization: Removed unauthorized fields: ${unauthorizedFields.join(', ')}`);
            }
        }
        next();
    };
 ...
 */
function preventCardDataStorage() {
    return (req, res, next) => {
        if (req.body) {
            ...
            if (hasSensitiveData) {
                logger_1.default.warn('PCI DSS: Removed sensitive card data from request body');
            }
        }
        next();
    };
 ...
 */
function securePaymentTransmission() {
    return (req, res, next) => {
 ...
 */
function complianceAuditTrail(resource, action) {
    return async (req, res, next) => {
        ...
        res.on('finish', () => {
            auditService_1.AuditService.log({
                ...
                logger_1.default.error('Failed to create compliance audit log:', error);
            });
        });
        next();
    };
 ...
 */
function validateSessionForCompliance() {
    return async (req, res, next) => {
        if (!req.user) {
            return next(new errors_1.ForbiddenError('Authentication required for compliance'));
        }
        // Check session age
        ...
        if (sessionId) {
            ...
            if (session) {
                ...
                if (sessionAge > maxSessionAge) {
                    ...
                    throw new errors_1.ForbiddenError('Session expired for compliance reasons. Please re-authenticate.');
                }
            }
        }
        next();
 ...
 */
function requireComplianceTraining() {
    return async (req, res, next) => {
 ...
 */
function complianceRateLimit(maxRequests = 100, windowMs = 900000) {
 ...
 */
async function checkPatientConsent(patientId, providerId, resourceType) {
    try {
        // In production, this would check the blockchain PatientConsent contract
        ...
        logger_1.default.error('Failed to check patient consent:', error);
        return false;
    }
}
/**
...
//# sourceMappingURL=complianceMiddleware.js.map