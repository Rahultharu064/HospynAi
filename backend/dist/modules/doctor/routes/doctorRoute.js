...
// List doctors
router.get('/', (0, validateMiddleware_1.validate)({ query: doctorValidator_1.doctorQuerySchema.shape.query }), (0, authMiddleware_1.authorize)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.RECEPTIONIST, client_1.UserRole.PATIENT), doctorController_1.DoctorController.list);
// Get doctor availability
router.get('/availability', (0, validateMiddleware_1.validate)({ query: doctorValidator_1.availabilityQuerySchema.shape.query }), (0, authMiddleware_1.authorize)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.ADMIN, client_1.UserRole.RECEPTIONIST, client_1.UserRole.PATIENT), doctorController_1.DoctorController.getAvailability);
// Get doctor by ID
